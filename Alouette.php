...
class Alouette {
	...
	static public function chanson($oiseau, $qualite, $action, $membres) {
		...
		$resultat .= '<div>'.$oiseau.', '.$action.'.</div>';
		$resultat .= '</div>';
		...
		$resultat .= '</div>';
		$resultat .= '</div>';
		$resultat .= '<div class="appel">'.$action.' '.$membre.'</div>';
		$resultat .= '<div class="reponse">'.$action.' '.$membre.'</div>';
	...
	static public function strophe($oiseau, $qualite, $action, $membre, $membresDits) {
		...
		$resultat .= '<div class="refrain">';
		$resultat .= '<div class="appel">';
		$resultat .= '<div>'.$action.', '.$qualite.' '.$action.'</div>';
		$resultat .= '<div>'.$action.', '.$action.'</div>';
		$resultat .= '</div>';
		$resultat .= '<div class="reponse">';
		$resultat .= '<div>'.$action.', '.$qualite.' '.$action.'</div>';
		$resultat .= '<div>'.$action.', '.$action.'</div>';
	...
	static public function couplet($oiseau, $action, $membre, $membresDits) {
		...
		$resultat .= '<div class="appel">'.$action.' '.$membre.'</div>';
		$resultat .= '<div class="reponse">'.$action.' '.$membre.'</div>';
		$resultat .= '<div class="appel">'.$membresDites.' '.$membre.'</div>';
		$resultat .= '<div class="reponse">'.$membresDites.' '.$membre.'</div>';
		$resultat .= '<div>Aaaah . . . </div>';
		return $resultat;
	}
